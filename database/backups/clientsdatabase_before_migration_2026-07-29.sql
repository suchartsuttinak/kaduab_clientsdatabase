...
CREATE TABLE `scholarship_children` (
  ...
  `scholarship_status` varchar(20) NOT NULL DEFAULT 'pending',
  `scholarship_status_updated_at` timestamp NULL DEFAULT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `scholarship_children_scholarship_status_index` (`scholarship_status`)
...
INSERT INTO `scholarship_children` VALUES (12,'นายสุชาติ','สุทธินาค','male',15,'มัธยมศึกษาปีที่ 1','โพธิสัมพันธ์วิทยาคาร (เมืองพัทยา 42)','2569','approved','2026-07-28 15:49:26','25','นายปรีดา ใชดี','0892536256','ทดสอบ','เทสระบบ','ทดสอบระบบ','upload/scholarship_children/6c542165-095f-4f35-9f07-3e6abea31d75.jpg','2026-07-01 05:15:51','2026-07-28 15:49:26'),(14,'นางสาวปิยะมาศ','ดีเลิศ','female',17,'มัธยมศึกษาปีที่ 6','โรงเรียนชลกันยานุกูล','2569','pending','2026-07-29 02:13:01','12 หมู่ที่ 8 ตำบลบ้านโขด อำเภอเมือง จังหวัดชลบุรี','นายปรีดา ใชดี','0855976596','ครอบครัวยากจน','ค่าใช้จ่ายเพื่อการศึกษา','เรียนดี ประพฤติดี','upload/scholarship_children/d5b5cc4f-68b6-482d-842f-cecb8af3c64a.jpg','2026-07-29 02:11:07','2026-07-29 02:13:01'),(15,'นายสุชาติ','สุทธินาค','male',16,'มัธยมศึกษาปีที่ 1','โรงเรียนบ้านสวนวิทยา','2570','approved','2026-07-29 02:24:07','25','นายปรีดา ใชดี','0869783512','ทดสอบ','ทดสอบ','ทดสอบ','upload/scholarship_children/ddf1a0d2-9ee2-4ac1-8450-18ca9bc4ec0a.jpg','2026-07-29 02:22:14','2026-07-29 02:24:07');
...
--
-- Table structure for table `scholarship_expense_attachments`
--

DROP TABLE IF EXISTS `scholarship_expense_attachments`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `scholarship_expense_attachments` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `scholarship_expense_id` bigint(20) unsigned NOT NULL,
  `category` varchar(30) NOT NULL,
  `file_path` varchar(255) NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `scholarship_expense_attachments_scholarship_expense_id_foreign` (`scholarship_expense_id`),
  KEY `scholarship_expense_attachments_uploaded_by_foreign` (`uploaded_by`),
  KEY `scholarship_expense_attachments_category_index` (`category`),
  CONSTRAINT `scholarship_expense_attachments_scholarship_expense_id_foreign` FOREIGN KEY (`scholarship_expense_id`) REFERENCES `scholarship_expenses` (`id`) ON DELETE CASCADE,
  CONSTRAINT `scholarship_expense_attachments_uploaded_by_foreign` FOREIGN KEY (`uploaded_by`) REFERENCES `users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `scholarship_expense_attachments`
--

LOCK TABLES `scholarship_expense_attachments` WRITE;
/*!40000 ALTER TABLE `scholarship_expense_attachments` DISABLE KEYS */;
/*!40000 ALTER TABLE `scholarship_expense_attachments` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `scholarship_expense_items`
--

DROP TABLE IF EXISTS `scholarship_expense_items`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `scholarship_expense_items` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `scholarship_expense_id` bigint(20) unsigned NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `scholarship_expense_items_scholarship_expense_id_foreign` (`scholarship_expense_id`),
  CONSTRAINT `scholarship_expense_items_scholarship_expense_id_foreign` FOREIGN KEY (`scholarship_expense_id`) REFERENCES `scholarship_expenses` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `scholarship_expense_items`
--

LOCK TABLES `scholarship_expense_items` WRITE;
/*!40000 ALTER TABLE `scholarship_expense_items` DISABLE KEYS */;
INSERT INTO `scholarship_expense_items` VALUES (7,3,'ค่าเทอม',20000.00,'2026-07-28 16:17:56','2026-07-28 16:17:56'),(8,3,'ค่าอุปกรณ์การเรียน',5000.00,'2026-07-28 16:17:56','2026-07-28 16:17:56'),(9,3,'ค่าอาหาร',2500.00,'2026-07-28 16:17:56','2026-07-28 16:17:56'),(10,4,'ทุนการศึกษา',15000.00,'2026-07-29 02:14:50','2026-07-29 02:14:50'),(11,5,'ทุนการศึกษา',25000.00,'2026-07-29 02:24:30','2026-07-29 02:24:30');
/*!40000 ALTER TABLE `scholarship_expense_items` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `scholarship_expenses`
--

DROP TABLE IF EXISTS `scholarship_expenses`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `scholarship_expenses` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `scholarship_child_id` bigint(20) unsigned NOT NULL,
  `record_date` date NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `scholarship_expenses_created_by_foreign` (`created_by`),
  KEY `scholarship_expenses_updated_by_foreign` (`updated_by`),
  KEY `scholarship_expenses_child_year_semester_index` (`scholarship_child_id`,`academic_year`,`semester`),
  KEY `scholarship_expenses_record_date_index` (`record_date`),
  KEY `scholarship_expenses_academic_year_index` (`academic_year`),
  CONSTRAINT `scholarship_expenses_created_by_foreign` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  CONSTRAINT `scholarship_expenses_scholarship_child_id_foreign` FOREIGN KEY (`scholarship_child_id`) REFERENCES `scholarship_children` (`id`) ON DELETE CASCADE,
  CONSTRAINT `scholarship_expenses_updated_by_foreign` FOREIGN KEY (`updated_by`) REFERENCES `users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `scholarship_expenses`
--

LOCK TABLES `scholarship_expenses` WRITE;
/*!40000 ALTER TABLE `scholarship_expenses` DISABLE KEYS */;
INSERT INTO `scholarship_expenses` VALUES (3,12,'2026-07-28','2569',1,27500.00,NULL,1,1,'2026-07-28 15:50:14','2026-07-28 16:17:56'),(4,12,'2026-07-29','2569',2,15000.00,NULL,1,1,'2026-07-29 02:14:50','2026-07-29 02:14:50'),(5,15,'2026-07-29','2570',1,25000.00,NULL,1,1,'2026-07-29 02:24:30','2026-07-29 02:24:30');
/*!40000 ALTER TABLE `scholarship_expenses` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `sessions` VALUES ('fLupVYxqplYdlgPSy4yG6VhFILJQjNZF4ZXpUrIp',1,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36','',1785292059);
...
--
-- Dumping events for database 'clientsdatabase'
--

--
-- Dumping routines for database 'clientsdatabase'
--
...
-- Dump completed on 2026-07-29 10:17:41
