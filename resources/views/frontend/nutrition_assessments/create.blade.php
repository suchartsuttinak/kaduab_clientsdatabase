...
<div class="container-fluid py-4 nutrition-page">
    ...
    <div class="nutrition-card">
       ...
       <form method="POST" action="{{ route('nutrition_assessments.store', $client->id) }}">
    @csrf

    @php
        $birthDate = $client->birth_date
            ? \Carbon\Carbon::parse($client->birth_date)
            : null;

        $assessmentDate = \Carbon\Carbon::parse(
            old('assessment_date', date('Y-m-d'))
        );
    ...
    <div class="row g-3">
      ...
      <div class="col-md-4">
            <label class="form-label">
                วันที่ชั่งวัด <span class="text-danger">*</span>
            </label>
