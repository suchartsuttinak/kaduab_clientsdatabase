...
<div class="container-fluid py-4 nutrition-page">
    <div class="nutrition-card">
        <div class="nutrition-header">
            <div>
                <h4>แก้ไขผลประเมินภาวะโภชนาการ</h4>
        ...
        @php
            ...
            $selectedDate = old('assessment_date', $assessment->assessment_date?->format('Y-m-d'));
            $assessmentDate = $selectedDate ? \Carbon\Carbon::parse($selectedDate) : now('Asia/Bangkok');
            $ageText = '-';
        ...
        <form id="nutritionForm" action="{{ route('nutrition_assessments.update', [$client->id, $assessment->id]) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="nutrition-actions">
                ...
                <button type="submit" id="submitButton" class="nutrition-btn nutrition-btn-primary">
                    <span class="button-normal"><i class="bi bi-save2-fill"></i> บันทึกการแก้ไข</span>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function updateAge() {
        if (!birthDate || !assessmentDate.value) { ageDisplay.value = '-'; return; }
        const birth = new Date(birthDate + 'T00:00:00');
        const assessed = new Date(assessmentDate.value + 'T00:00:00');
        if (assessed < birth) { ageDisplay.value = '-'; return; }
