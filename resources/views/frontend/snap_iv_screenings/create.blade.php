    ...
    <div class="container-fluid snap-page">
        ...
        <div class="snap-card">
            ...
            <div class="snap-body">
                ...
                <form action="{{ route('snap-iv.store', $client->id) }}" method="POST">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-lg-3 mb-3">
                            ...
                            <input type="text" name="relationship" value="{{ old('relationship', 'ครูประจำชั้น') }}"
                                class="form-control">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-lg-4 mb-3">
                            ...
                            <input type="text" name="term" value="{{ old('term') }}" class="form-control">
                        ...
                        <div class="col-lg-4 mb-3">
                            ...
                            <input type="text" name="grade_average" value="{{ old('grade_average') }}"
                                class="form-control">
                                        ...
                                        @foreach ($scoreLabels as $score => $label)
                                            <div class="form-check">
                                                ...
                                                <input class="form-check-input" type="radio"
                                                    ...
                                                    {{ old("answers.$category.$itemNo") == (string) $score ? 'checked' : '' }}>
