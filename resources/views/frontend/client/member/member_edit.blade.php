...
@php
    $formMembers = old('members', $client->members->map(function ($member) {
            return [
...
<div class="member-form-page">
    <div class="member-form-shell">
        <div class="member-form-header">
            <div>
                <span class="member-form-kicker">EDIT FAMILY MEMBER</span>
                <h1 class="member-form-title">แก้ไขข้อมูลสมาชิกในครอบครัว</h1>
            </div>
        ...
        <form action="{{ route('member.update', $client->id) }}"
              method="POST"
              id="member-form"
              novalidate>
            @csrf
            ...
            <div class="member-form-body">
                ...
                <div class="member-form-actions">
                    ...
                    <div class="member-form-actions-right">
                        <a href="{{ route('member.show', $client->id) }}"
