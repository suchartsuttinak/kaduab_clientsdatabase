...
{{-- ACCIDENT_DATATABLE_CHECKBODY_LAYOUT_V3_FINAL --}}
...
<style>
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Accident DataTable — layout เดียวกับหน้า Check Body
    |--------------------------------------------------------------------------
    | Toolbar (จำนวนรายการ / ค้นหา) อยู่นอกกรอบตาราง
    | และให้เฉพาะตัวตารางเป็นส่วนที่เลื่อนแนวนอน
    */
